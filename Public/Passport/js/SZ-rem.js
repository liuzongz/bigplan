//font-size change rem
! function(a) {
	function b() {
		var b = g.getBoundingClientRect().width;
		b / c > 768 && (b = 768 * c), a.rem = b / 16, g.style.fontSize = a.rem + "px"
	}
	var c, d, e, f = a.document,
		g = f.documentElement,
		h = f.querySelector('meta[name="viewport"]'),
		i = f.querySelector('meta[name="flexible"]');
	if(h) { /*console.warn("将根据已有的meta标签来设置缩放比例");*/
