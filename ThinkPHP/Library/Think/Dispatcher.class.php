...
class Dispatcher {
    ...
    static private function getController($var,$urlCase) {
        ...
        return htmlspecialchars(strip_tags(ucfirst($controller)),ENT_QUOTES);
    }
    ...
    static private function getAction($var,$urlCase) {
        ...
        return htmlspecialchars(strip_tags( $urlCase? strtolower($action) : $action ),ENT_QUOTES);
    }
    ...
    static private function getModule($var) {
        ...
        return htmlspecialchars(strip_tags(ucfirst($module)),ENT_QUOTES);
    }
