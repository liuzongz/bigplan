...
class Mysql extends Driver{
    ...
    public function insertAll($dataSet,$options=array(),$replace=false) {
        ...
        $sql    =  (true===$replace?'REPLACE':'INSERT').' INTO '.$this->parseTable($options['table']).' ('.implode(',', $fields).') VALUES '.implode(',',$values).$this->parseDuplicate($replace);//echo $sql . "\n";
        $sql    .= $this->parseComment(!empty($options['comment'])?$options['comment']:'');//echo $sql;
