 ...
 */
namespace Wap\Plugins\shipping;
defined('MJJ_SHOP') and die('Hacking attempt');
$shipping_lang = '/language/sto_express.php';
if (file_exists(__DIR__ . $shipping_lang)) {
    global $_LANG;
...
{
    include_once(APP_PATH . '../Public/plugins/languages/' . $GLOBALS['_CFG']['lang'] . '/admin/shipping.php');
